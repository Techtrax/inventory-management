...
export default {
  ...
  setup() {
    ...
    const handlePOCreated = (poData) => {
      // Update the backlog item with the new PO ID and mark it as having a PO
      // (has_purchase_order is the field the backend/template actually rely on;
      // purchase_order_id/purchase_order are kept as a client-side cache)
